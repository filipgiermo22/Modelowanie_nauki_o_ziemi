...
while (1) {
  ...
  if (kk * dtr + dtr / 10.0 >= dt) {
    ...
    # TODO: dodanie próbek do sejsmogramu. Wymyślić sposóv w jaki
    #       zapisywać próbki sejsmogramu do macierzy która będzie je przechowywać
    
    # TODO: napisać warunek podobny jak w 111 dla animacji
